...
import com.ccf.glesapp.polygon.threed.Cone;
import com.ccf.glesapp.polygon.threed.Cube;
import com.ccf.glesapp.polygon.threed.Cylinder;
import com.ccf.glesapp.polygon.threed.Oval;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

public class Polygon3DActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mif.inflate(R.menu.polygon_3d, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.cone:
                ...
                break;
            case R.id.cube:
                mInnerRenderer = new Cube(this);
                break;
            case R.id.cylinder:
                mInnerRenderer = new Cylinder(this);
                break;
            case R.id.oval:
                mInnerRenderer = new Oval(this);
                break;
        }
        setRenderer();
