package com.ccf.glesapp.video.util;
...
public class VaryTools {
	...
	// 设置相机
	public void setCamera(float ex, float ey, float ez, float cx, float cy,
	...
	public void frustum(float left, float right, float bottom, float top,
		...
		Matrix.frustumM(mMatrixProjection, 0, left, right, bottom, top, near,
				far);
	}
