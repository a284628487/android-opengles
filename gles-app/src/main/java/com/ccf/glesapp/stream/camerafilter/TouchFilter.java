...
public class TouchFilter extends StreamFilter {
    ...
    public void onSurfaceCreated() {
        createProgramByAssetsFile("vshader/camera/CameraPreviewTouch.shader",
                "fshader/camera/CameraPreviewTouch.shader");
