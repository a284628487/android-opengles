...
public class KitkatCamera implements ICamera {
	...
	public boolean open(int cameraId) {
		...
		if (mCamera != null) {
			...
			Log.e("wuwang", "camera previewSize:" + mPreSize.x + "/"
					+ mPreSize.y);
			return true;
		}
		return false;
	...
	public void setOnPreviewFrameCallbackWithBuffer(
			final PreviewFrameCallback callback) {
		if (mCamera != null) {
	...
	private Camera.Size getPropPreviewSize(List<Camera.Size> list, float th,
			int minWidth) {
	...
	private Camera.Size getPropPictureSize(List<Camera.Size> list, float th,
			int minWidth) {
		Collections.sort(list, sizeComparator);
