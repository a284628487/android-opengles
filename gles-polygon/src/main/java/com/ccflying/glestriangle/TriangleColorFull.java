...
public class TriangleColorFull implements GLSurfaceView.Renderer {

    private final static String TAG = "TriangleColorFull";
    //
    ...
    public TriangleColorFull(Context context) {
