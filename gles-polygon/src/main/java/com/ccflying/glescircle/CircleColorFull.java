...
public class CircleColorFull implements GLSurfaceView.Renderer {
    ...
    private float[] initCircleCoords() {
        ...
        for (int i = 0; i <= n; i++) {
            ...
            baseOfx = (i + 1) * 4;
            colors[baseOfx + 0] = 1f - colorStep * i / 255;
            colors[baseOfx + 1] = colorStep * i / 255;
            colors[baseOfx + 2] = 1f - colorStep * i / 255 / 2;
            colors[baseOfx + 3] = 1f;
        }
        return f;
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        // 颜色值为4个，所以size为4;
        GLES20.glVertexAttribPointer(mGLColorHandle, 4, GLES20.GL_FLOAT, false, 16, colorBuffer);
        // 绘制三角形
